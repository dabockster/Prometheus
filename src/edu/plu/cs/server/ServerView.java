...
public class ServerView extends javax.swing.JFrame {
     ...
     * @param feedback the message to be relayed
     */
    public void accountsFeedback(String feedback){
        registeredAccountsTA.append(feedback + "\n");
    }
     ...
     * @param feedback the message to be relayed
     */
    public void onlineFeedback(String feedback){
        onlineAccountsTA.append(feedback + "\n");
    }
    ...
    private void initComponents() {
        ...
        shutDownButton.setText("New Client View");
